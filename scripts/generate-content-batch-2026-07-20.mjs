...
<tr><td style="background-color:#050505;border-radius:20px 20px 0 0;padding:22px 36px;"><img src="${site}/images/logo/ap-chip-light.png?v=1" width="168" height="44" alt="Ahn Partners" style="display:block;border:0;"></td></tr>
